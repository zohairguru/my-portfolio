      ...
      <div className="flex-about">
        <div className="about-text">
          <p>
            ...
            technologies such as HTML, CSS, JavaScript and NEXTjs. I enjoy working on both the front-end and
          ...
          <p>Throughout my career, I have worked on a wide range of projects, from simple static websites to
            ...
            tools and frameworks, including React, Nextjs 13, Node.js, and Wordpress. I am always eager
        ...
        <div className="about-img">
          <Image src='/images/aboutme.jpg' className="profile-img" width={300} height={500}/>
        </div>
      </div>
    </div>
  )
